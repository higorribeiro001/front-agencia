...
export default function Orders() {
    ...
    const handleSearch = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        timeout = setTimeout(async () => {
            if (e.target.value !== "") {
                ...
                const orderAdapt = new LogisticAdapt(dataLogistics);

                const logisticData = orderAdapt.externalLogisticAdapt;
    ...
    const ContentViewOrder = ({dataLogistic}: DataLogisticInterface) => {
        return (
