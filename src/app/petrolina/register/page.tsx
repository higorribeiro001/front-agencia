...
import { unityItems } from "@/app/service/api/unity";
...
export default function RegisterPetrolina() {
    ...
    const changeValues = (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
        ...
        // if (index === 1) {
        //   const employee = getEmployee(e.target.value);
      
        //   employee.then((value) => {
        //     model[index+1].value = value.id ? value.id : ''
        //     model[index+1].label = value ? value.funcionario : initModel[index+1].label;
        //   });
        // }
