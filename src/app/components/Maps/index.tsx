      ...
      html: `
        <div class="bg-white rounded-lg shadow-md h-full hover:scale-110 transition-transform duration-500">
          <div class="card-marker-content">
            <img style="width: 300px; height: 150px; object-fit: cover; border-radius: 4px 4px 0 0;" 
                 src="${photoUrl}" alt="Local" />
            <div class="p-1">
    ...
    <div>
      <div className="flex justify-center w-[80%] absolute z-50 p-3 mx-8 px-14">
        <Autocomplete
          ...
          className="w-full"
          value={selectedTrip}
          onChange={(event, newValue) => newValue && setSelectedTrip(newValue)}
            ...
            <TextField
              ...
              sx={{
                ...
                '& .MuiOutlinedInput-input': {
                  color: 'var(--black2)',
                  '&::placeholder': { color: 'var(--black2)', opacity: 1 },
                },
                '& .MuiInputLabel-root': {
                  color: 'var(--black2)',
                  '&.Mui-focused': { color: 'var(--black2)' },
                },
              }}
              InputProps={{
                ...params.InputProps,
