        ...
        { field: 'is_active', headerName: 'Status', width: 100, renderCell: (params) => {
            return (
                <div className="flex justify-center items-center py-[10px]">
                    <div className="flex justify-center items-center font-semibold px-2 w-full" style={params.value ? { backgroundColor: 'green', color: 'white', height: '30px', borderRadius: '4px' } : { backgroundColor: 'red', color: 'white', padding: '5px', borderRadius: '4px' }}>
            ...
            >
                <div className="flex flex-col justify-between gap-4 px-10 py-5 h-full">
                    ...
                    <footer className="flex flex-row justify-between gap-3">
                        <IconButton 
                            className="gap-2"
                            href={"/employees/edit-employees/"+dataEmployee?.id}
                        >
                            <Edit 
                                fontSize="small"
                                color="success" 
            ...
            <div className="transition-all h-full">
                <div className="animate-fade-up">
                    <DataTable 
                        ...
                        isLoading={isLoading} 
                        pages={pages}     
                        hrefRegister="/employees/register-employees" 
