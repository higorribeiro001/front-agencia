...
import { postTypeProduct } from "@/app/service/api/typeProducts";

export default function RegisterTypeProduct() {
    ...
    const submitForm = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      const registerTypeProduct = async () => {
        try {
          const response = await postTypeProduct(
            { 
              tipo: model[0].value
            });
        ...
        >
          <div className="flex flex-col gap-6 w-full h-full z-10 relative animate-fade-up">
              ...
              <div className="flex flex-row w-full justify-between z-10 relative">
                  <IconButton href="/type-products" className="text-[var(--black2)]">
                    <ArrowBack />
                  </IconButton>
                  <Button 
