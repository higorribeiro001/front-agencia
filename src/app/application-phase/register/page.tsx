...
import { postApplicationPhase } from "@/app/service/api/applicationPhase";

export default function RegisterApplicationPhase() {
    ...
    const submitForm = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      const registerApplicationPhase = async () => {
        try {
          const response = await postApplicationPhase(
            { 
    ...
    return (
        <Base 
          title="Cadastro de Fase de Aplicação"
          openAlert={openAlert}
          isSuccess={isSuccess}
        ...
        >
          <div className="flex flex-col gap-6 w-full h-full z-10 relative animate-fade-up">
              ...
              <div className="flex flex-row w-full justify-between z-10 relative">
                  <IconButton href="/application-phase" className="text-[var(--black2)]">
                    <ArrowBack />
                  </IconButton>
                  <Button 
