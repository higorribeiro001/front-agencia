...
import { Autocomplete, Breadcrumbs, Button, Divider, IconButton, Link, TextField } from "@mui/material";
    ...
    return (
        <div className="flex flex-col gap-6 w-full h-full z-10 relative animate-fade-up">
          ...
          <Breadcrumbs aria-label="breadcrumb">
            <h2 className="font-medium cursor-pointer text-[20px]" onClick={() => window.location.reload()}>Fazenda</h2>
            <h2 className="font-bold text-[20px]">Cadastrar</h2>
          </Breadcrumbs>
